...
const GameCard = () => {
  return (
    <View style={styles.container}>
      <Image
        source={{
          uri: "https://www.cultofthelamb.com/videos/woolhaven-bg-poster.png",
        }}
        style={styles.image}
      />
      {/* Título e Publicadora */}
      <Text style={styles.gameTitle}>Cult of the Lamb</Text>
      <Text style={styles.publisher}>Devolver Digital</Text>

      {/* Container para Classificação Etária e Preço lado a lado */}
      <View style={styles.infoRow}>
        {/* Classificação Etária com Ícone */}
        ...
        <View style={styles.priceContainer}>
          <Text style={styles.price}>R$ 64,95</Text>
        </View>
      </View>
    </View>
  );
